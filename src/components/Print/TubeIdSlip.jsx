...
const TubeIdSlip = ({ order, user, settings }) => {
  const now = new Date();
  return (
    <Wrapper className="print-only-premium">
      <Watermark>TUBE ID SLIP</Watermark>
      <Header>
        <Logo>
          {/* <img src={logo} alt="Logo" style={{height:32}} /> */}
          SmartLab
        </Logo>
        <Title>Tube ID Slip</Title>
        <Meta>
      ...
      <Section>
        ...
        <InfoGrid>
          ...
          <InfoItem><strong>Tube ID:</strong> {order?.id?.substring(0, 8) || 'N/A'}</InfoItem>
        </InfoGrid>
      </Section>
      <Section>
      ...
      <SignatureRow>
        <SignatureBox>Phlebotomist Signature</SignatureBox>
